...
```
https://github.com/RekonOps/BugBeacon-unity.git
```
...
```
https://github.com/RekonOps/BugBeacon-unity.git#v0.1.0
```

### .unitypackage로 설치

1. [GitHub Releases](https://github.com/RekonOps/BugBeacon-unity/releases) 페이지에서 최신 `.unitypackage` 파일 다운로드
...
```
git clone https://github.com/RekonOps/BugBeacon-unity.git
```
...
- [GitHub Issues](https://github.com/RekonOps/BugBeacon-unity/issues) - 버그 리포트 및 기능 요청
