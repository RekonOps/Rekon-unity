...
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/RekonOps/Bug-OneTouch-unity.git
   ```
...
1. Check existing [Issues](https://github.com/RekonOps/Bug-OneTouch-unity/issues) to avoid duplicates.
