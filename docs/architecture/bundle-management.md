...
Bug-OneTouch Unity 플러그인의 M2 마일스톤은 캡처 파이프라인(M1)에서 생성된 아티팩트를
...
- **최대 번들 수**: 200개 (BugOneTouchSettings.maxBundles)
- **최대 디스크 사용량**: 5,120MB / 5GB (BugOneTouchSettings.maxDiskUsageMB)
